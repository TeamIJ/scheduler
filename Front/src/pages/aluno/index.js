...
function formataDataLista(dataAtinga) {
  ...
  return (
    <>
      {user ?
        <>
          <Head>
            <title>Scheduler - Aluno</title>
          </Head>
          <Navbar user={user.name.split(' ')[0]} />
            ...
            <form className={styles.main} onSubmit={(e) => gravaAgendamento(e)} >
              ...
              <div className={styles.tipoAgendamento}>
                <FormControl >
                  ...
                  >
                    <FormControlLabel checked={tipoAgendamento === 'R'} value="R" control={<Radio size="small" />} label="Reposição" sx={{
                      '& .MuiFormControlLabel-label': {
                        fontSize: '90%'
                      }
                    }} />
                    <FormControlLabel checked={tipoAgendamento === 'T'} value="T" control={<Radio size="small" />} label="Treinamento" sx={{
                      '& .MuiFormControlLabel-label': {
                        fontSize: '90%'
                      }
                    }} />
                ...
                <div className={styles.historyList}>
                  ...
                  return (
                      <div key={agendamento.id} className={styles.agendamento}>
                        ...
                        <p><span>Professor: </span> {agendamento.professor}</p>
                        <p><span>Data: </span> {formataDataLista(agendamento.data)} <span>Horário: </span> {agendamento.horario.substring(0, 5)}</p>
                      </div>
                    )
                  })}
                </div>
